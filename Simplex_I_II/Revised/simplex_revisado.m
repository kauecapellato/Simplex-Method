function [ind v] = simplex_revisado(A,b,c,m,n,x,indB,Binv)
   ...
   contador = 1;
    ...
    # Condições sobre o vetor u
		# Critério de parada -> Todos os valores são <= 0: Problema ilimitado, custo ótimo -inf e o algoritmo termina
		if max(u(indB)) <= 0	
			ind = -1;
      x = '';
			v = u;
